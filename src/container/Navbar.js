    ...
    <div className={classes.root}>
      ...
      >
        <div className={classes.drawerHeader}>
          ...
          >
            <Logo width="100%" height="100%" className={classes.logo} />
          </div>
          <div
        ...
        <List className={classes.navList}>
          <Link to="/types" className={classes.link}>
            <ListItem button selected={location.includes('types')}>
              <ListItemText primary="LECTURES" />
            </ListItem>
          </Link>
          <Link to="/students" className={classes.link}>
            <ListItem button selected={location === '/students'}>
